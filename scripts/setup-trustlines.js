...
const AETH_ASSET = new Asset('AETH', issuerKeypair.publicKey());
...
async function setupTrustlines() {
  try {
    ...
    console.log("Issued 1,000,000 AETH to distributor");
...
module.exports = { setupTrustlines, addTrustline, AETH_ASSET };
